...
func (s *SuspendServer) GetDescribe() string {
	return "gateway封停解封交易接口服务 例: uri_switch  -h 127.0.0.1 -p 9999 -u gateway -w gateway -s 885e492d-bec8-4268-a2fc-ce0162c066fc -c GATEWAY-GSCT-TEST -n cfzt-edb -e false -U \"/cfzt-edb/query\" -a cfzt-edb "
}
